    ...
    return (
        ...
        >
            <Link href={`/projects/${slug}`}>
                ...
                <div className="absolute inset-0 bg-gradient-to-t from-black/50 via-transparent to-transparent lg:from-transparent lg:via-transparent lg:bg-black/0 lg:group-hover:bg-black/20 transition-colors duration-500" />
                ...
                <div className="absolute bottom-0 left-0 right-0 p-8 w-full translate-y-0 opacity-100 lg:translate-y-4 lg:opacity-0 transition-all duration-500 lg:group-hover:translate-y-0 lg:group-hover:opacity-100">
                    ...
                    <h3 className="text-white font-serif text-2xl lg:text-3xl">{title}</h3>
                </div>
            </Link>
        </motion.div>
    );

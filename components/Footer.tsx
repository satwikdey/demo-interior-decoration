        ...
        <footer className="bg-brand-red text-white/80 font-sans">
            <div className="max-w-screen-2xl mx-auto px-8 md:px-16 py-16 md:py-24">
                <div className="grid grid-cols-1 md:grid-cols-4 gap-12 md:gap-8 items-start">
                    ...
                    <div className="flex flex-col space-y-12 md:space-y-16 col-span-1 md:col-span-2">
                        ...
                        <div className="flex flex-col md:flex-row gap-8 md:gap-16 text-xs uppercase tracking-[0.2em]">
                            <div className="space-y-2">
                                <p className="font-bold text-white mb-4">Address</p>
                                <p className="leading-relaxed">123 Design Avenue<br/>Mumbai, India</p>
                            </div>
                            <div className="space-y-2">
                                <p className="font-bold text-white mb-4">Phone</p>
                                <p className="leading-relaxed">+91 98765 43210</p>
                            </div>
                            <div className="space-y-2">
                                <p className="font-bold text-white mb-4">Email</p>
                ...
                {/* Copyright */}
                <div className="mt-24 pt-8 border-t border-white/20 text-xs tracking-widest uppercase text-white/50 text-right">

        ...
        <main className="pt-32 pb-24 bg-[#DFD6CD] min-h-screen">
            <Container>
                <div className="max-w-3xl mx-auto text-center mb-16">
                    ...
                    <p className="text-[#6A5A49]/70 font-light text-lg">
                ...
                <div className="max-w-4xl mx-auto space-y-8">
                    <div className="border-t border-b border-[#9A8E84]/35 py-8 flex flex-col md:flex-row justify-between items-baseline">
                        <div>
                            <h3 className="font-serif text-2xl mb-2">Senior Interior Designer</h3>
                            <p className="text-[#6A5A49]/70 font-light">London, UK &nbsp;|&nbsp; Full Time</p>
                        </div>
                    ...
                    <div className="border-b border-[#9A8E84]/35 py-8 flex flex-col md:flex-row justify-between items-baseline">
                        <div>
                            <h3 className="font-serif text-2xl mb-2">FF&E Designer</h3>
                            <p className="text-[#6A5A49]/70 font-light">New York, USA &nbsp;|&nbsp; Full Time</p>
                        </div>
                        <button className="mt-4 md:mt-0 text-sm uppercase tracking-widest font-bold hover:text-primary transition-colors">Apply Now</button>
                    </div>
                    ...
                    <div className="border-b border-[#9A8E84]/35 py-8 flex flex-col md:flex-row justify-between items-baseline">
                        <div>
                            ...
                            <p className="text-[#6A5A49]/70 font-light">London, UK &nbsp;|&nbsp; Contract</p>
                        </div>
                        <button className="mt-4 md:mt-0 text-sm uppercase tracking-widest font-bold hover:text-primary transition-colors">Apply Now</button>
                    </div>
                </div>

                <div className="text-center mt-16 text-[#6A5A49]/70 font-light text-sm">

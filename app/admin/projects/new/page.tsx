          ...
          <div className="lg:col-span-2 space-y-12">
            ...
            <section className="bg-[#DFD6CD] p-10 border border-[#9A8E84]/20 shadow-sm space-y-8">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                <div>
                  ...
                  <input name="title" required className="w-full border-b border-[#9A8E84]/20 py-2 focus:border-[#6A5A49] outline-none transition-colors" placeholder="e.g. 5 Ballygunge" />
                </div>
                <div>
                  <label className="block text-[10px] uppercase tracking-widest text-[#9A8E84] mb-2">Slug (URL)</label>
                  <input name="slug" required className="w-full border-b border-[#9A8E84]/20 py-2 focus:border-[#6A5A49] outline-none transition-colors" placeholder="e.g. ballygunge-residence" />
                </div>
                <div>
                  <label className="block text-[10px] uppercase tracking-widest text-[#9A8E84] mb-2">Location</label>
                  <input name="location" required className="w-full border-b border-[#9A8E84]/20 py-2 focus:border-[#6A5A49] outline-none transition-colors" placeholder="e.g. Kolkata, India" />
                </div>
                <div>
                  <label className="block text-[10px] uppercase tracking-widest text-[#9A8E84] mb-2">Category</label>
                  <select name="category" required className="w-full border-b border-[#9A8E84]/20 py-2 focus:border-[#6A5A49] outline-none bg-transparent">
              ...
              <div>
                ...
                <textarea name="description" rows={3} required className="w-full border border-[#9A8E84]/20 p-4 focus:border-[#6A5A49] outline-none transition-colors font-light text-sm" placeholder="A brief overview for the grid..." />
              </div>
            </section>
            ...
            <section className="bg-[#DFD6CD] p-10 border border-[#9A8E84]/20 shadow-sm space-y-8">
              ...
              <div className="space-y-8">
                {blocks.length === 0 && (
                  <p className="text-center py-12 text-[#9A8E84] italic text-sm">Add text or images to build the project detail page...</p>
                )}
          ...
          <div className="space-y-8">
            <section className="bg-[#DFD6CD] p-10 border border-[#9A8E84]/20 shadow-sm space-y-6 sticky top-32">
              ...
              <div className="pt-6">
                ...
                {!mainImage && <p className="text-[9px] text-[#6A5A49] mt-2 text-center uppercase tracking-tighter">Thumbnail is required</p>}
              </div>
            </section>
          </div>
        </form>
